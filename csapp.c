...
int help_(){
	...
	printf("   - Israel Alan Agoe-Sowah\n");
	printf("Usage:\n");
	printf("  - User can change prompt with '-p' followed by user-inputted prompt\n");
	printf("**********************************************************************\n\n");
	printf("BUILTIN COMMANDS:");
	printf("   - exit: This command terminates the shell \n");
	printf("   - cd: This command allows the shell to change directories to the filepath following the 'cd'\n");
	printf("   - ppid: This command prints the PID of the parent process\n");
	printf("   - pid: This command prints the PID of the current process\n");
	printf("   - help: This command shows the information about the shell as well as builtin commands and  \n");
	printf("   - quit : This command exits the shell \n");
	printf("SYSTEM COMMANDS:\n");
	printf("   - For system commands use man pages to access descriptions\n");
